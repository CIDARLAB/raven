...
public class FusionTest {
    ...
    @Test
    public void fusionORGateTest() throws Exception {
        String filePath = getFilepath() + "/src/main/resources/RavenTestFiles/endy_OR_gate_fusion.csv";
